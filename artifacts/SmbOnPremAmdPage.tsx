...
import { SmbOnPremAmdProvider } from '@/contexts/SmbOnPremAmdContext';
import Hero from '@/components/smbOnPremAmd/Hero';
import FunnelSection from '@/components/smbOnPremAmd/FunnelSection';
import UsagePatternTimeline from '@/components/smbOnPremAmd/UsagePatternTimeline';
import PersonasAndCohorts from '@/components/smbOnPremAmd/PersonasAndCohorts';
import CapabilityMatrix from '@/components/smbOnPremAmd/CapabilityMatrix';
import DemandVsCapacity from '@/components/smbOnPremAmd/DemandVsCapacity';
import CapacityCurveSection from '@/components/smbOnPremAmd/CapacityCurveSection';
import TcoSection from '@/components/smbOnPremAmd/TcoSection';
import MethodologySpec from '@/components/smbOnPremAmd/MethodologySpec';
import SizingCalculator from '@/components/smbOnPremAmd/SizingCalculator';
import BottlenecksSection from '@/components/smbOnPremAmd/BottlenecksSection';
        ...
        <div className="border-b border-border/50 bg-background/80 backdrop-blur-sm sticky top-0 z-30">
          <div className="mx-auto max-w-[1100px] px-4 py-3 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-bold leading-tight">SMB On-Prem AI · Sizing Study (AMD)</h1>
                <p className="text-[11px] text-muted-foreground">
                  Dell R7625 · 2× AMD EPYC 9374F (32C) · Qwen3-30B-A3B-Instruct (FP8) · vLLM dual-socket on CPU
                </p>
              </div>
            </div>
          </div>
